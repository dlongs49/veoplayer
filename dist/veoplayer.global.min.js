  ...
  var VeoPlayer = /*#__PURE__*/function (_CreateVeoNode) {
    ...
    _createClass(VeoPlayer, [{
      ...
      value: function voeInitVolume() {
        ...
        if (type === 'init') {
          volumeNum = !this.muted ? this.volume / _classPrivateFieldGet(this, _VOLUME_LEN) : 0;
          height = !this.muted ? volumeHeight * this.volume / _classPrivateFieldGet(this, _VOLUME_LEN) / volumeHeight * 100 : 0;
        } else {

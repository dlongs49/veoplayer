...
var VeoPlayer = (function () {
  ...
  var _PROCESS_SIZE = /*#__PURE__*/new WeakMap();
  ...
  var CreateVeoNode = /*#__PURE__*/function (_paramsRules) {
    ...
    function CreateVeoNode(arg) {
      ...
      _classPrivateFieldInitSpec(_assertThisInitialized(_this), _PROCESS_SIZE, {
        writable: true,
        value: 6
      });
      _this.id = id;
  ...
  function _createParentNode2() {
    ...
    this.styleArr.map(function (v) {
      ...
      if (v.key === "animation") {
        if (!_this2.isBool(v.value)) {
          throw new Error("animation\u4E0D\u7B26\u5408\u6570\u636E\u7C7B\u578B\uFF0C\u671F\u5F85\u6570\u636E\u7C7B\u578B\u4E3A [boolean]");
        }
        _this2.isAnimation = v.value;
      }
      if (v.key === "processHeight") {
        if (!_this2.isNumber(v.value)) {
          throw new Error("processHeight\u4E0D\u7B26\u5408\u6570\u636E\u7C7B\u578B\uFF0C\u671F\u5F85\u6570\u636E\u7C7B\u578B\u4E3A [number]");
        }
        if (v.value > 6) {
          _classPrivateFieldSet(_this2, _PROCESS_SIZE, v.value);
  ...
  function _createVideoNode2(veoVideo) {
    ...
    var sourceaAdd = function sourceaAdd(i) {
      ...
      video.autoplay = _this3.autoplay;
      source.src = i === "string" ? _this3.url : _this3.url[i];
  ...
  function _createControlNode2() {
    ...
    if (!this.isBool()) {
      ...
      var veoProcessVir = document.createElement("div");
      ...
      veoProcessCon.style.height = "".concat(_classPrivateFieldGet(this, _PROCESS_SIZE), "px");
  ...
  function _createProgressNode2() {
    var _classPrivateMethodGe = _classPrivateMethodGet(this, _getControlNode, _getControlNode2).call(this),
      VEO_PROCESS_VIR_NODE = _classPrivateMethodGe.VEO_PROCESS_VIR_NODE;
    ...
    for (var i = 0; i < VEO_PROCESS_LIST.length; i++) {
      ...
      if (pro) {
        ...
        if (i === 3) {
          // 进度条最小的高度
          if (_classPrivateFieldGet(this, _PROCESS_SIZE) > 6) {
            var h = _classPrivateFieldGet(this, _PROCESS_SIZE) + 10;
            veoProcess.style.height = veoProcess.style.width = h + "px";
            // 计算圆形滑块的 top 值 相对于父级
            veoProcess.style.top = (_classPrivateFieldGet(this, _PROCESS_SIZE) * 0.8 - h) / 2 + 1 + "px";
          }
        }
      }
    }
    ...
    _createClass(VeoPlayer, [{
      ...
      value: function initPlayer() {
        var _this$initNode = this.initNode(),
          ...
          veoScreen = _this$initNode.veoScreen,
          veoSetting = _this$initNode.veoSetting,
      ...
      value: function veoProcessOffset() {
        ...
        // 计算进度条值
        var compute = function compute(x) {
          var veoConWidth = veoContainer.offsetWidth;
          var veoSubWidth = veoSub.offsetWidth;
          var currentTime = duration * x / veoConWidth;
          // 进度条 width 值
          var ingWidth = x / veoConWidth;
          //滑块 left 值
          var subWidth = (x - veoSubWidth / 2) / veoConWidth;
      ...
      value: function veoTimeUpdate(callback) {
        ...
        var _this$initNode15 = this.initNode(),
          ...
          _this$initNode15.veoCon;
          _this$initNode15.veoIng;
          var veoSub = _this$initNode15.veoSub;
          _this$initNode15.veoTimeIng;
        veoSub.offsetWidth;
        veo.addEventListener("timeupdate", function (e) {
          ...
          _this8.computedPorcess(currentTime);
          return;
        });
      }
      ...
      key: "computedPorcess",
      value: function computedPorcess(data) {
        var _this$initNode16 = this.initNode(),
          veo = _this$initNode16.veo,
          veoCon = _this$initNode16.veoCon,
          veoIng = _this$initNode16.veoIng,
          veoSub = _this$initNode16.veoSub,
          veoTimeIng = _this$initNode16.veoTimeIng;
        var veoSubWidth = veoSub.offsetWidth;
        if (veoCon != null) {
          var veoConWidth = veoCon.offsetWidth;
          var duration = veo.duration;
          var ingWidth = veoConWidth * data / duration / veoConWidth;
          var subWidth = (veoConWidth * data / duration - veoSubWidth / 2) / veoConWidth;
          if (veoIng) {
            veoIng.style.width = ingWidth * 100 + '%';
            veoSub.style.left = subWidth * 100 + '%';
          }
      ...
      key: "veoSetCurrentTime",
      value: function veoSetCurrentTime() {
        var _this$initNode17 = this.initNode(),
          veo = _this$initNode17.veo;
      ...
      value: function veoPlayPauseNode(type) {
        var _this$initNode18 = this.initNode(),
          veo = _this$initNode18.veo,
          veoPlayPause = _this$initNode18.veoPlayPause,
      ...
      value: function veoPlayPause() {
        ...
        var _this$initNode19 = this.initNode(),
          veoPlayPause = _this$initNode19.veoPlayPause;
      ...
      value: function veoConPlay() {
        ...
        var _this$initNode20 = this.initNode(),
          veoVideo = _this$initNode20.veoVideo,
          veoMutualPlay = _this$initNode20.veoMutualPlay,
          veoMutualPause = _this$initNode20.veoMutualPause;
      ...
      value: function veoPlayEnded(callback) {
        ...
        var _this$initNode21 = this.initNode(),
          ...
          veoContainer = _this$initNode21.veoContainer;
        veo.addEventListener("ended", function (e) {
          if (callback) {
            callback(e);
          }
          veoContainer.classList.add("veo-control-isshow");
          _this11.veoPlayPauseNode('pause');
        });
      }
      ...
      value: function veoSpeedNode() {
        ...
        var _this$initNode22 = this.initNode(),
          ...
          veoSpeedItemNode = _this$initNode22.veoSpeedItemNode;
        var _loop = function _loop(i) {
          veoSpeedItemNode[i].addEventListener("click", function (e) {
            ...
            veo.playbackRate = _this12.speed[i];
          });
        };
      ...
      value: function voeDownLoad() {
        ...
        var _this$initNode24 = this.initNode(),
          veoDownload = _this$initNode24.veoDownload;
          _this$initNode24.veo;
        veoDownload.addEventListener("click", function (e) {
          fetch(_this13.url).then(function (res) {
            return res.blob();
          }).then(function (blob) {
      ...
      value: function handleVeoSetting() {
        var _this$initNode25 = this.initNode(),
          veoSwitch = _this$initNode25.veoSwitch,
          veo = _this$initNode25.veo;
          _this$initNode25.veoSetting;
      ...
      value: function veoCapture() {
        var _this$initNode26 = this.initNode(),
          ...
          veoCapture = _this$initNode26.veoCapture;
        var canvas = document.createElement('canvas');
        ...
        for (var i = 0; i < volumeList.length; i++) {
          volumeList[i].addEventListener("click", function (e) {
            ...
            if (val === "volume") {
              ...
              _this14.computedVolume("volume_params", null, 0);
            } else {
              _this14.veoIsMuted(false);
              _this14.computedVolume("volume_params", null, _this14.volume);
            }
          });
        }
      }
      ...
      key: "computedVolume",
      value: function computedVolume(type) {
        var offsetY = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var volume = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
        var _this$initNode29 = this.initNode(),
          veo = _this$initNode29.veo,
          veoVolumeProgressPertxt = _this$initNode29.veoVolumeProgressPertxt,
          veoVolumeProgress = _this$initNode29.veoVolumeProgress,
          veoVolumeProgressIng = _this$initNode29.veoVolumeProgressIng,
        ...
        if (type === "volume_params") {
          volumeNum = volume / _classPrivateFieldGet(this, _VOLUME_LEN);
          height = !this.muted ? volumeHeight * volume / _classPrivateFieldGet(this, _VOLUME_LEN) / volumeHeight * 100 : 0;
        } else {
          // 根据拖拽音量条计算
          var y = volumeHeight - offsetY;
      ...
      value: function veoHandleVolume() {
        ...
        var _this$initNode31 = this.initNode(),
          veoVolumeProgress = _this$initNode31.veoVolumeProgress,
          veoVolume = _this$initNode31.veoVolume,
          veoVolumeProgressBar = _this$initNode31.veoVolumeProgressBar;
        veoVolume.getElementsByTagName("svg");
        veoVolumeProgress.addEventListener("click", function (e) {
          var y = e.offsetY;
          _this15.voeInitVolume(null, y);
        });
        ...
        var elemMove = function elemMove(e) {
          ...
          if (by > -1 && by <= 100) {
            _this15.voeInitVolume(null, proHeight - offset);
            _this15.veoIsMuted(false);
          }
          if (by <= 0) {
            _this15.veoIsMuted(true);
          }
        };
        veoVolumeProgressBar.addEventListener("mousedown", function (e) {
          barY = e.clientY;
      ...
      value: function veoScreen(params) {
        ...
        var _this$initNode32 = this.initNode(),
          ...
          veoScreen = _this$initNode32.veoScreen;
        var screenFunc = function screenFunc(data) {
          if (data) {
            ...
            //     veoContainer.classList.remove("veo-control-isshow")
            // }, 2000);
            veoScreen.dataset.index = _this16.isFullScreen = 0;
            veoScreen.setAttribute("label", "退出");
          } else {
            document.exitFullscreen();
            veoScreen.dataset.index = _this16.isFullScreen = 1;
      ...
      value: function veoKeyCode() {
        var _this17 = this;
        var _this$initNode33 = this.initNode(),
          veoPlayPause = _this$initNode33.veoPlayPause;
        document.addEventListener("keyup", function (e) {
          var key = e.key;
          if (key === " ") {
            var type = veoPlayPause.dataset.type;
            _this17.veoPlayPauseNode(type);
          }
        });
      }
      ...
      value: function veoDestroy(params) {
        var _this$initNode34 = this.initNode(),
          veoContainer = _this$initNode34.veoContainer;
        if (params) {
          veoContainer.remove();
        } else {

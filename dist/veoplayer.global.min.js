    ...
    _createClass(VeoPlayer, [{
      ...
      value: function veoProcessOffset() {
        ...
        var _this$initNode14 = this.initNode(),
          ...
          _this$initNode14.veoScreen;
          var veoContainer = _this$initNode14.veoContainer;
        var barX = 0;
        var barLeft = 0;
      ...
      value: function veoTimeUpdate(callback) {
        ...
        veo.addEventListener("timeupdate", function (e) {
          ...
          if (veoCon != null) {
            ...
            var subWidth = (veoConWidth * currentTime / duration - veoSubWidth / 2) / veoConWidth;
            if (veoIng) {
              veoIng.style.width = ingWidth * 100 + '%';
              veoSub.style.left = subWidth * 100 + '%';
            }
